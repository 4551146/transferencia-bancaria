package cl.kibernum.m5actividad4;
...
@ConfigurationParameter(key = GLUE_PROPERTY_NAME, value = "cl.kibernum.m5actividad4.steps") // Indicar donde estan los steps definitions
